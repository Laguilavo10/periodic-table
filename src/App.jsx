...
let elementos = [
  ...
  },
  {
    ...
    facts:
      "Most abundant element on earth, Most abundant element in human body",
    group: "16",
    groupBlock: "nonmetal",
    ionRadius: "140 (-2)",
  ...
  },
  {
    ...
    facts: "Most reactive solid element, Highest electronegativity",
    group: "17",
    groupBlock: "halogen",
    ionRadius: "133 (-1)",
    ...
    meltingPoint: "54",
    molarHeatCapacity:
      "Cp- 31 J/(mol·K) (at 21.1 °C) ,  Cv- 23 J/(mol·K)[5] (at 21.1 °C)",
    name: "Fluorine",
    oxidationStates: "-1",
    period: "2",
    speedOfSound: "",
...
function App() {
  ...
  //   .then((response) => setElementos(response))
      ...
      <div className='tabla-periodica'>
        ...
        <TablaPeriodica>
          {elementos.map((e, index) => (
            <ElementoTabla info={e} key={index} index={index + 1} setElementoDetalle={setElementoDetalle}/>
          ))}
        </TablaPeriodica>
